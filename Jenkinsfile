 ...
 agent any
  ...
  post { 
        success { 
            ...
            azureUpload storageCredentialId: 'azurestorageaccount', storageType: 'blobstorage', containerName: 'pythondatabricks', filesPath: 'code_holder.tar.gz', virtualPath: 'test'
        }
